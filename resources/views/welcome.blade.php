...
<html lang="en">
  ...
  <head>
    ...
    <link href="{{asset('css/welcomescreen/css/new-age.min.css')}}" rel="stylesheet">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="http://www.mdc.ph">Mater Dei College</a>
    ...
    <script src="{{asset('js/welcomescreen/js/new-age.min.js')}}"></script>
